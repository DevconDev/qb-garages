...
Garages = {
    ...
    ['boatcar'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-738.13641357422, -1504.7501220703),
            vector2(-747.58911132812, -1509.1799316406),
            vector2(-751.17785644531, -1500.0557861328),
            vector2(-741.46350097656, -1496.2839355469),
            },
            ['minZ'] =  3.0,  -- min height of the parking zone
            ['maxZ'] = 39.0,  -- max height of the parking zone
        },
        label = 'Boat Shop Parking',
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(-741.32, -1500.89, 4.65, 21.98),
            vector4(-744.1, -1502.53, 4.65, 22.55),
            vector4(-747.41, -1503.64, 4.65, 20.44),
        },
        debug = false
    },
}
